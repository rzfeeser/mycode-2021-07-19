...
def parsecsvdata():
    ...
    # open csv data
    with open("/home/student/mycode/datasets/2018summary.csv",\
     "r") as downtime:
...
def main():
    ...
    try:
        ...
        print("Check the location of your input file and run the program again!")
        exit()
    except IndexError:
        print("Something is wrong with the way you formatted your data. Do you have an extra line at the bottom?")
        exit()
    except Exception as failed:   # generic catch-all
        print("Well, I didn't expect that!")
        print(f"The type of error occuring is: {failed}")  # reveal what type of error we forgot to trap
        exit()
    ...
    plt.savefig("/home/student/mycode/2018summaryv2.png")
    # Save to "~/static"
